        ...
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          {posts.slice(0, MAX_DISPLAY).map((frontMatter) => {
            ...
            return (
              <li
                key={slug}
                className="py-4 sm:py-8 hover:opacity-50 transition-opacity duration-300"
              >
                <article>
                  <div className="space-y-2 xl:grid xl:grid-cols-4 xl:space-y-0 xl:items-baseline">
                    ...
                    <div className="space-y-3 xl:col-span-3">
                      <div className="space-y-2 sm:space-y-4">
                        <div>
                          <h2 className="text-xl sm:text-2xl font-bold leading-8 tracking-tight ">
                            <Link
                              href={`/blog/${slug}`}
                        ...
                        <div className="text-sm leading-5 sm:prose sm:leading-6 text-gray-500 max-w-none dark:text-gray-400">
                          {summary}
                        </div>
                      </div>
